 ...
 */
class Magestore_Getdata_Block_Adminhtml__Grid extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     *
     * @return Magestore_Getdata_Block_Adminhtml__Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('getdata/')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('content', array(
            'header'    => Mage::helper('getdata')->__(' Content'),
            'width'     => '150px',
            'index'     => 'content',
        ));
