...
/**
 *  Edit Form Content Tab Block
 * 
 * @category    Magestore
 * @package     Magestore_Getdata
 * @author      Magestore Developer
 */
class Magestore_Getdata_Block_Adminhtml__Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare tab form's information
     *
     * @return Magestore_Getdata_Block_Adminhtml__Edit_Tab_Form
     */
    protected function _prepareForm()
    {
        ...
        if (Mage::getSingleton('adminhtml/session')->getData()) {
            ...
            $data = Mage::registry('_data')->getData();
        }
        $fieldset = $form->addFieldset('_form', array(
            'legend'=>Mage::helper('getdata')->__(' information')
        ));
