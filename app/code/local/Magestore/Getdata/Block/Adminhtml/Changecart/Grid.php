...
/**
 * Changecart Grid Block
 * 
 * @category    Magestore
 * @package     Magestore_Getdata
 * @author      Magestore Developer
 */
class Magestore_Getdata_Block_Adminhtml_Changecart_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('changecartGrid');
        $this->setDefaultSort('changecart_id');
     ...
     *
     * @return Magestore_Getdata_Block_Adminhtml_Changecart_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('getdata/changecart')->getCollection();
    ...
    {
        $this->addColumn('changecart_id', array(
        ...
        $this->addColumn('content', array(
            'header'    => Mage::helper('getdata')->__('Changecart Content'),
            'width'     => '150px',
            'index'     => 'content',
        ));
    ...
    {
        $this->setMassactionIdField('changecart_id');
        $this->getMassactionBlock()->setFormFieldName('changecart');
