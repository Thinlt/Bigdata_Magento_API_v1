 ...
 */
class Magestore_Getdata_Block_Adminhtml_Checkout_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('checkoutGrid');
        $this->setDefaultSort('checkout_id');
     ...
     *
     * @return Magestore_Getdata_Block_Adminhtml_Checkout_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('getdata/checkout')->getCollection();
    ...
    {
        $this->addColumn('checkout_id', array(
        ...
        $this->addColumn('content', array(
            'header'    => Mage::helper('getdata')->__('Checkout Content'),
            'width'     => '150px',
            'index'     => 'content',
        ));
    ...
    {
        $this->setMassactionIdField('checkout_id');
        $this->getMassactionBlock()->setFormFieldName('checkout');
