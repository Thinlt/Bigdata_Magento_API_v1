 ...
 */
class Magestore_Getdata_Block_Adminhtml_Review_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     *
     * @return Magestore_Getdata_Block_Adminhtml_Review_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('getdata/review')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('content', array(
            'header'    => Mage::helper('getdata')->__('Review Content'),
            'width'     => '150px',
            'index'     => 'content',
        ));
