 ...
 */
class Magestore_Getdata_Block_Adminhtml_Test_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     *
     * @return Magestore_Getdata_Block_Adminhtml_Test_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('getdata/test')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('content', array(
            'header'    => Mage::helper('getdata')->__('Test Content'),
            'width'     => '150px',
            'index'     => 'content',
        ));
