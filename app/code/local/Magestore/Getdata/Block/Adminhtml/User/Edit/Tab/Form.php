...
/**
 * User Edit Form Content Tab Block
 * 
 * @category    Magestore
 * @package     Magestore_Getdata
 * @author      Magestore Developer
 */
class Magestore_Getdata_Block_Adminhtml_User_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare tab form's information
     *
     * @return Magestore_Getdata_Block_Adminhtml_User_Edit_Tab_Form
     */
    protected function _prepareForm()
    {
        ...
        if (Mage::getSingleton('adminhtml/session')->getUserData()) {
            $data = Mage::getSingleton('adminhtml/session')->getUserData();
        ...
        $fieldset = $form->addFieldset('user_form', array(
            'legend'=>Mage::helper('getdata')->__('User information')
        ));
