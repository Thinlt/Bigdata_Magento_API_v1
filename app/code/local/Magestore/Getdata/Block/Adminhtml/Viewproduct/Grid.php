...
/**
 * Viewproduct Grid Block
 * 
 * @category    Magestore
 * @package     Magestore_Getdata
 * @author      Magestore Developer
 */
class Magestore_Getdata_Block_Adminhtml_Viewproduct_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('viewproductGrid');
        $this->setDefaultSort('viewproduct_id');
     ...
     *
     * @return Magestore_Getdata_Block_Adminhtml_Viewproduct_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('getdata/viewproduct')->getCollection();
    ...
    {
        $this->addColumn('viewproduct_id', array(
            'header'    => Mage::helper('getdata')->__('ID'),
            'align'     =>'right',
			'type'		=> 'number',
            'width'     => '50px',
            'index'     => 'viewproduct_id',
        ));
        ...
        $this->addColumn('content', array(
            'header'    => Mage::helper('getdata')->__('Viewproduct Content'),
            'width'     => '150px',
            'index'     => 'content',
        ));
    ...
    {
        $this->setMassactionIdField('viewproduct_id');
        $this->getMassactionBlock()->setFormFieldName('viewproduct');
