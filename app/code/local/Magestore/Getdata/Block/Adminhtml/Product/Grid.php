 ...
 */
class Magestore_Getdata_Block_Adminhtml_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     *
     * @return Magestore_Getdata_Block_Adminhtml_Product_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('getdata/product')->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('content', array(
            'header'    => Mage::helper('getdata')->__('Product Content'),
            'width'     => '150px',
            'index'     => 'content',
        ));
