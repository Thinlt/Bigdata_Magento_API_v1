...
/**
 * Product Edit Form Content Tab Block
 * 
 * @category    Magestore
 * @package     Magestore_Getdata
 * @author      Magestore Developer
 */
class Magestore_Getdata_Block_Adminhtml_Product_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * prepare tab form's information
     *
     * @return Magestore_Getdata_Block_Adminhtml_Product_Edit_Tab_Form
     */
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('product_form', array(
            'legend'=>Mage::helper('getdata')->__('Product information')
        ));
